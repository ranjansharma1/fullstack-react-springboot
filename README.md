...
1. `npm install` -- for installing dependency
2. `npm start` -- for starting application
3. `npm run build` -- for development server
...
## Reference
- GitHub Link: https://github.com/darbyluv2code/fullstack-react-and-springboot
