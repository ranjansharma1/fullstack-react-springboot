...
export const PaymentStatusPage = () => {
  ...
  return (
    <div className="bg-success-subtle" style={{ height: "100vh" }}>
      <div className="container">
        <h1 className="mb-5">Payment Receipt</h1>
        <h5>e-Receipt for State Bank Collect Payment</h5>
        <hr />
        <div className="container">
            <p><strong>Date: </strong>{orderData.paymentDate}</p>
            <hr />
            <p><strong>Transaction Number: </strong>{orderData.transactionId}</p>
            <hr />
            <p><strong>Receipt Number: </strong>{orderData.reciept}</p>
            <hr />
            ...
            <hr />
            <p><strong>Book Name: </strong>{orderData.bookTitle}</p>
            <hr />
