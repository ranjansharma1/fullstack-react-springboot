 ...
 * data. @RequestParam("category") String category: This annotation indicates
 ...
 * represents the category value to be searched. Pageable pageable: This
 * parameter represents the pagination information, allowing for the control of
 * the result set's size and ordering. Pageable is an interface in Spring Data
 * that provides methods for specifying pagination parameters like page number,
